...
INPUT_FILE = Path("results/golden_batch_1.csv")
OUTPUT_FILE = Path("results/golden_batch_1_review.txt")
...
def main():
    ...
    with OUTPUT_FILE.open("w", encoding="utf-8") as f:
        f.write("HIVER GOLDEN SET — BATCH 1 HUMAN REVIEW\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("\n")
        f.write("IMPORTANT: signal_* fields are sampling aids only.\n")
    ...
    print("Golden Batch 1 review file created.")
